...
class Auction(models.Model):
    ...
    def __str__(self):
        return f"Auction {self.id}{self.id}: {self.item_name} ({self.user.username})"
...
class Bid(models.Model):
    ...
    def __str__(self):
        return f"Bid {self.id}{self.id}: {self.amount} on {self.auction.item_name} by {self.user.username}"
